...
- Node.js 22 or newer
- pnpm 11
- PostgreSQL will be introduced in T-003; it is not required for T-001
...
It prints the current worker health contract and exits. Persistent scheduling starts in later Tasks.
...
packages/       domain and infrastructure packages added by later Tasks

...
- [-] FR-04 Deploy and release — Vercel Web/Cron and launch-critical T-032 smoke gate
  - [!] Vercel five-minute Cron — Hobby plan does not allow minute-level schedules; Production `CRON_SECRET` is absent
